...
# TODO Current todo
"""
1.Make most operation doing on Session instead of Server
2.Make LLM to recieve independent chat history instead of list of messages
3.Make location management system

"""

# Location data class to manage characters and chat history in a location

class LocationData:
    
    # Initialize location data with prompt, chat history, and character lists
    ...
    # Add player character to location
    ...
    # Choose character to talk based on context
    def choose_character_to_talk(self, full_character_list):
        prompt_1_sys = (
        ...
        prompt_2_user += (
            ...
            f"{json.dumps(self.independent_chat_history, indent=2, ensure_ascii=False)}\n"
        )
...
# Session class to manage world, characters, locations, and chat history
